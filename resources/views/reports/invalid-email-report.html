...
<head>
  <title>Invalid Email Report</title>
  <meta charset="utf-8" />
    ...
    <form class="row g-2">
      ...
      <div class="col-md-3 mb-1">
        ...
        <select class="form-select">
          ...
          <option value="">BDC Manager</option>
      ...
      <table style="white-space: nowrap; border-collapse: collapse; width: 100%;">
        ...
        <tbody>
          <tr>
            ...
            <td>123 King St W, Toronto, ON</td>
            <td>Customer clicked "Unsubscribe" link.</td>
          </tr>
          <tr>
            <td>Maria Gonzalez</td>
            <td>Sarah Lee</td>
            <td>maria.gonzalez@email.com</td>
            <td>+1 (647) 555-1122</td>
            <td>-</td>
            <td>+1 (647) 555-7788</td>
            <td>45 Queen St, Mississauga, ON</td>
            <td>Email address bounced – invalid domain.</td>
          </tr>
          <tr>
            <td>Ahmed Khan</td>
            <td>David Miller</td>
            ...
            <td>-</td>
            <td>2200 Dundas St, Brampton, ON</td>
            <td>Customer reported email as spam.</td>
          </tr>
          <tr>
            <td>Emily Davis</td>
            <td>Robert Wilson</td>
            ...
            <td>-</td>
            <td>-</td>
            <td>78 Lakeshore Rd, Oakville, ON</td>
            <td>Customer opted out via preferences center.</td>
          </tr>
        </tbody>
      </table>
    </div>
