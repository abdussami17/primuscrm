...
<div class="col-md-12 mt-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0">
                ...
                <button type="button" class="btn btn-light btn-sm ms-1 border"
                        data-bs-toggle="modal" data-bs-target="#gotoinventoryModal">
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center">
                                ...
                                <i class="toggle-deal-details-icon ti ti-caret-down-filled ms-2"
                                   style="cursor:pointer;"
    ...
    <div class="col-md-3">
        ...
        <select class="form-select form-select-sm"
            ...
            @foreach ([
                'Internet', 'Walk-In', 'Phone Up', 'Text Up',
                'Website Chat', 'Import', 'Wholesale', 'Lease Renewal'
            ] as $type)
    ...
    <div class="col-md-3">
        ...
        <select class="form-select form-select-sm"
            ...
            @foreach(['finance' => 'Finance', 'cash' => 'Cash', 'lease' => 'Lease'] as $val => $label)
                <option value="{{ $val }}" @selected(strtolower($deal->deal_type ?? '') === $val)>{{ $label }}</option>
            @endforeach
        </select>
    </div>
...
<div class="modal fade" id="documentsModal" tabindex="-1" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body" id="documentsModalBody">
            ...
            <div class="list-group mb-3" id="docList"><div class="list-group-item d-flex justify-content-between align-items-center">
      ...
      </div><div class="list-group-item d-flex justify-content-between align-items-center">
...
async function updateDealField(dealId, field, value) {
    try {
        await api(`/api/deals/${dealId}/field`, 'PATCH', { field, value });
        showToast('Updated');
    } catch {
