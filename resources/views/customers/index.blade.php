                                ...
                                <div class="tab-pane" id="profile-tab-2">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-4 mb-2" id="startDateCol">
                                            ...
                                            <input type="text" class="form-control" id="startDate" placeholder="Select date &amp; time" readonly autocomplete="off">
                                        </div>
                                        <div class="col-md-4 mb-3" id="endDateCol">
                                            <label class="form-label">End Date</label>
                                            <input type="text" class="form-control" id="endDate" placeholder="Select date &amp; time" readonly autocomplete="off">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="bg-light p-2 text-center" id="mass-box"
                                                style="display: block;">
                                                <i id="massSendSummaryText">Select a start date to see the scheduled send summary.</i>
                                            </div>
