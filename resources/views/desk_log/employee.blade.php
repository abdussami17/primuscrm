...
@section('title', "Employee's Desklog")
@section('content')
    <div class="content content-two p-0 ps-3 pe-3" id="showroom-page">
        ...
        <div class="position-relative d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3"
            ...
            <div>
                <h6 class="mb-0">Employee's Desklog</h6>
            </div>
        ...
        <div class="split-container">
            <div class="split-view">
                <div class="crm-box">
                    ...
                    {{-- Main Filter Form --}}
                    <form class="row g-2" id="filterForm" method="GET" action="{{ route('employee-desk-log.employee') }}">
            ...
            'next7days' => 'Next 7 Days',
                                ...
                                <span
                                    ...
                                    data-url="{{ route('employee-desk-log.employee', array_merge($filters, ['preset' => $preset])) }}"
                                    ...
                                    <div id="showroom-actions-{{ $deal->id }}"
                                        ...
                                        @if ($latestVisit)
                                            {{-- <div class="small text-muted mt-1">
                                                {{ $latestVisit->start_time?->format('M d, Y h:i A') }}</div>
